...
func (q *DBQuerier) Backtick(ctx context.Context) (string, error) {
	...
	return pgx.CollectExactlyOneRow(rows, func(row pgx.CollectableRow) (string, error) {
		...
		if err := plan0.Scan(vals[0], &item); err != nil {
			return item, fmt.Errorf("scan Backtick.?column?: %w", err)
		}
		return item, nil
	})
}
...
func (q *DBQuerier) BacktickQuoteBacktick(ctx context.Context) (string, error) {
	...
	return pgx.CollectExactlyOneRow(rows, func(row pgx.CollectableRow) (string, error) {
		...
		var item string
		if err := plan0.Scan(vals[0], &item); err != nil {
			return item, fmt.Errorf("scan BacktickQuoteBacktick.?column?: %w", err)
		}
		return item, nil
	})
}
...
func (q *DBQuerier) BacktickNewline(ctx context.Context) (string, error) {
	...
	return pgx.CollectExactlyOneRow(rows, func(row pgx.CollectableRow) (string, error) {
		...
		var item string
		if err := plan0.Scan(vals[0], &item); err != nil {
			return item, fmt.Errorf("scan BacktickNewline.?column?: %w", err)
		}
		return item, nil
	})
}
...
func (q *DBQuerier) BacktickDoubleQuote(ctx context.Context) (string, error) {
	...
	return pgx.CollectExactlyOneRow(rows, func(row pgx.CollectableRow) (string, error) {
		...
		var item string
		if err := plan0.Scan(vals[0], &item); err != nil {
			return item, fmt.Errorf("scan BacktickDoubleQuote.?column?: %w", err)
		}
		return item, nil
	})
}
...
func (q *DBQuerier) BacktickBackslashN(ctx context.Context) (string, error) {
	...
	return pgx.CollectExactlyOneRow(rows, func(row pgx.CollectableRow) (string, error) {
		...
		var item string
		if err := plan0.Scan(vals[0], &item); err != nil {
			return item, fmt.Errorf("scan BacktickBackslashN.?column?: %w", err)
		}
		return item, nil
	})
}
...
func (q *DBQuerier) IllegalNameSymbols(ctx context.Context, helloWorld string) (IllegalNameSymbolsRow, error) {
	...
	return pgx.CollectExactlyOneRow(rows, func(row pgx.CollectableRow) (IllegalNameSymbolsRow, error) {
		...
		if err := plan0.Scan(vals[0], &item); err != nil {
			return item, fmt.Errorf("scan IllegalNameSymbols.$: %w", err)
		}
		if err := plan1.Scan(vals[1], &item); err != nil {
			return item, fmt.Errorf("scan IllegalNameSymbols.foo.bar!@#$%&*()"--+: %w", err)
		}
		return item, nil
	})
}
...
func (q *DBQuerier) SpaceAfter(ctx context.Context, space string) (string, error) {
	...
	return pgx.CollectExactlyOneRow(rows, func(row pgx.CollectableRow) (string, error) {
		...
		var item string
		if err := plan0.Scan(vals[0], &item); err != nil {
			return item, fmt.Errorf("scan SpaceAfter.?column?: %w", err)
		}
		return item, nil
	})
}
...
func (q *DBQuerier) GoKeyword(ctx context.Context, go_ string) (string, error) {
	...
	return pgx.CollectExactlyOneRow(rows, func(row pgx.CollectableRow) (string, error) {
		...
		var item string
		if err := plan0.Scan(vals[0], &item); err != nil {
			return item, fmt.Errorf("scan GoKeyword.text: %w", err)
		}
		return item, nil
	})
}
