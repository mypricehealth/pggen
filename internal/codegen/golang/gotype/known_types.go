...
var (
	...
	PgJSON             = MustParseKnownType("[]byte", pg.JSON)
	...
	PgJSONB            = MustParseKnownType("[]byte", pg.JSONB)
	PgJSONBArray       = MustParseKnownType("github.com/jackc/pgx/v5/pgtype.FlatArray[[]byte]", pg.JSONBArray)
