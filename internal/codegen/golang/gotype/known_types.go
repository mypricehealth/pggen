...
var (
	...
	PgMacaddrArray     = MustParseKnownType("github.com/jackc/pgx/v5/pgtype.FlatArray[pgtype.Macaddr]", pg.MacaddrArray)
	...
	PgJSONBArray       = MustParseKnownType("github.com/jackc/pgx/v5/pgtype.FlatArray[pgtype.JSONB]", pg.JSONBArray)
