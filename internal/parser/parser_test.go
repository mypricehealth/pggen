			...
			},
			{
				...
				[]ast.Query{
					&ast.SourceQuery{
						...
						DenseSQL:    []ast.DenseSQL{{SQL: "SELECT $1;", Args: []int{0}}, {SQL: "\nSELECT $1, $2;", Args: []int{1, 0}}},
						PreparedSQL: "SELECT $1;\nSELECT $2, $1;\n",
					...
					&ast.SourceQuery{
						...
						Start:       42,
						SourceSQL:   []string{"SELECT pggen.arg('arg0');"},
						DenseSQL:    []ast.DenseSQL{{SQL: "SELECT $1;", Args: []int{0}}},
						PreparedSQL: "SELECT $1;",
	...
	tests := []struct {
		...
		},
		{
			...
			&ast.SourceQuery{
				...
				DenseSQL:    []ast.DenseSQL{{SQL: "SELECT $1, $2, $1;", Args: []int{0, 1, 0}}},
		...
		},
		{
			...
			&ast.SourceQuery{
				...
				Doc:         &ast.CommentGroup{List: []*ast.LineComment{{Text: "-- name: Qux :many"}}},
				SourceSQL:   []string{"SELECT /*pggen.arg('Bar'),*/ pggen.arg('Qux'), pggen.arg('Bar');"},
				DenseSQL:    []ast.DenseSQL{{SQL: "SELECT /*pggen.arg('Bar'),*/ $1, $2;", Args: []int{0, 1}}},
