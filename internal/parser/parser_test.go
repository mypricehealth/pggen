		...
		}{
			{
				...
				[]ast.Query{
					&ast.SourceQuery{
						...
						DenseSQL:    []ast.DenseSQL{{SQL: "SELECT 1;"}, {SQL: "\nSELECT 2;"}},
					...
					&ast.SourceQuery{
						...
						DenseSQL:    []ast.DenseSQL{{SQL: "SELECT 3;"}},
			...
			},
			{
				...
				[]ast.Query{
					&ast.SourceQuery{
						...
						DenseSQL:    []ast.DenseSQL{{SQL: "SELECT $1;", Args: []int{0}, UniqueArgs: 1}, {SQL: "\nSELECT $1, $2;", Args: []int{1, 0}, UniqueArgs: 2}},
						PreparedSQL: "SELECT $1;\nSELECT $2, $1;",
					...
					&ast.SourceQuery{
						...
						Start:       42,
						SourceSQL:   []string{"SELECT pggen.arg('arg0');"},
						DenseSQL:    []ast.DenseSQL{{SQL: "SELECT $1;", Args: []int{0}, UniqueArgs: 1}},
						PreparedSQL: "SELECT $1;",
	...
	tests := []struct {
	...
	}{
		{
			...
			&ast.SourceQuery{
				...
				SourceSQL:   []string{"SELECT 1;"},
				DenseSQL:    []ast.DenseSQL{{SQL: "SELECT 1;"}},
				PreparedSQL: "SELECT 1;",
		...
		},
		{
			...
			&ast.SourceQuery{
				...
				DenseSQL:    []ast.DenseSQL{{SQL: "SELECT $1, $2, $1;", Args: []int{0, 1}, UniqueArgs: 2}},
		...
		},
		{
			...
			&ast.SourceQuery{
				...
				Doc:         &ast.CommentGroup{List: []*ast.LineComment{{Text: "-- name: Qux :many"}}},
				SourceSQL:   []string{"SELECT /*pggen.arg('Bar'),*/ pggen.arg('Qux'), pggen.arg('Bar');"},
				DenseSQL:    []ast.DenseSQL{{SQL: "SELECT /*pggen.arg('Bar'),*/ $1, $2;", Args: []int{0, 1}, UniqueArgs: 2}},
